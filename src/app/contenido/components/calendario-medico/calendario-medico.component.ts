...
export class CalendarioMedicoComponent implements OnInit {
  ...
  public obtenerDatos(dni: string) {
    ...
    if (datoUsuario) {
      ...
      this._antecedentesService.getAntecedentesByIdUsuarioFecha(
        dni,
        this.dateValue._i
      )
        .subscribe({
  ...
  public marcarFechas(dni: string) {
    ...
    if (usuario) {
      ...
      this._datosRespiratoriosService.getDatosRespiratoriosByDni(dni).subscribe({
        next: (data: DatosRespiratorios[]) => {
          this.ObtenerFechas(data);
          console.log("datos Respiratorios", data);
      ...
      this._deportesService.getDeportesByIdUsuario(dni).subscribe({
        next: (data: Deporte[]) => {
          this.ObtenerFechas(data);
          console.log("datos Deportes", data);
      ...
      this._glicadasService.getGlicadasByDni(dni).subscribe({
        next: (data: Glicada[]) => {
          this.ObtenerFechas(data);
          console.log("datos Glicadas", data);
        },
        error: (err: HttpErrorResponse) => {
          console.log(err);
        }
      ...
      this._tensionServices.getTensionesByDni(dni).subscribe({
        next: (data: Tension[]) => {
          this.ObtenerFechas(data);
          console.log("datos Tensiones", data);
        },
        error: (err: HttpErrorResponse) => {
          console.log(err);
        }
